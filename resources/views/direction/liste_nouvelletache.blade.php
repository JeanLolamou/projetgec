                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $demandeurmanifestation->date_bedut }}</td>
                                             <td>{{ $demandeurmanifestation->statut_manifestation }}</td>
                                              <td>{{ $demandeurmanifestation->departement_affecte }}</td>
                                            <td> <?php if($demandeurmanifestation->etat_operation=='envoyer') 
                                            {?>
                                                <a href="{{route('apercunovelletache',$demandeurmanifestation->id)}}" type="button" class="btn btn-warning waves-effect">
                                                    <i class="material-icons">visibility</i>
                                                    <span>Afficher</span>
                                                 </a>
                                          <?php    }
                                            else{?>
                                                <a href="{{route('tacheemployeencour',$demandeurmanifestation->id)}}" type="button" class="btn btn-warning waves-effect">
                                                    <i class="material-icons">visibility</i>
                                                    <span>Afficher</span>
                                                 </a>
