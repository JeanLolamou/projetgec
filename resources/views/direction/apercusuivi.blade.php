...
<div class="invoice overflow-auto">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="header">
                            ...
                            <div style="float: right;"><h3>Date Debut:<span>{{$editvalidation->date_bedut}}</span></h3></div>
    ...
    <footer>
                 <form id="form_validation" method="POST">
                             ...
                             <!--          <a href="{{route('manifestation.affectationvalidation',$editvalidation->id)}}" type="button" class="btn btn-success waves-effect">
