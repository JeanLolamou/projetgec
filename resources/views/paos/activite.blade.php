...
<div class="row">
        <div class="col-lg-12">
            ...
            <span class="title"></span><i class="fa fa-home"></i> Accueil</button></a>
                ...
                <form action="{{ route('activite')}}" method="GET" class="form-inline">
...
<div class="row">
                       ...
                       <div class="form-group">
                            <label class="control-label" for="select"><b>Direction</b></label>
                        ...
                        <div class="col-lg-2">
                      <div class="form-group">
                            <label class=" control-label" for="select"><b>Statuts</b></label>
                          ...
                          <div class="col-lg-2">
                        <div class="form-group">
                            <label class="control-label" for="input-small"><b>Début</b></label>
                        ...
                        <div class="col-lg-2">
                         <div class="form-group">
                            <label class="control-label" for="input-small"><b>Fin</b></label>
                              @if(isset($exist_fin))
                       ...
                       if (!isset($exist_dir)) {
                        ...
                        if (!isset($exist_fin)) {
                         ...
                         ?>
           <a target="_blank" href="{{ route('export_activite').'?'.$query }}" 
              class="btn btn-sm btn-warning">
              <i class="fa fa-print"></i> 
            Imprimer
          </a>
           <a class="btn btn-sm btn-primary" href="{{ route('export_activite').'?format=excel&'.$query }}">Export Excel </a>
            </div> </div> 
                    </form>
                ...
                <thead class="bg-info">
                  <tr>
                     ...
                     <th style="width:8px;">Activités</th> 
                      <th style="width:8px;">Indicateur</th> 
                    <!-- <th >Indicateurs</th> -->
                    <th >Statuts</th>
                    <th >Début</th>
                    <th >Fin</th>
 ...
 <tfoot class="bg-info"> 
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-default" data-dismiss="modal">Fermer</button>
                  ...
                  @endif
                  <td><b>{{$activites->indicateur}}</b></td>
                   <td>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <h4 class="modal-title ml-2">Liste Reporting Activité [<span style="color: red;">{{$activites->libelle}}</span>]</h4>
        <div class="modal-body">
