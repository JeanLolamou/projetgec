...
@endif<h6 style="text-transform: uppercase;font-weight: bolder;text-align: center;">Modifier Un Poste: </h6>
        ...
        <div class="row flex-grow">
          <div class="col-lg-12 d-flex align-items-center justify-content-center" >
            <div class="auth-form-transparent text-left p-3">
              ...
              <form id="form_validation" method="POST" class="pt-3" action="{{ route('posteupdate') }}">
                                      {{ csrf_field() }}
                                {{ method_field('PUT') }}


              
<input type="hidden" name="id" value="{{$editpostes->id}}">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group-prepend bg-transparent">
                      <span class="input-group-text bg-transparent border-right-0">
                        ...
                        <input id="nom" class="form-control" value="{{$editpostes->User_poste}}" name="nom" type="text" placeholder="Poste" required="required" >
                      </div>
