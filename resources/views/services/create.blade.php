...
@endif<h6 style="text-transform: uppercase;font-weight: bolder;text-align: center;">Enregistrer un nouveau Service:</h6>
        ...
        <div class="row flex-grow">
          <div class="col-lg-12 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-left p-3">
              ...
              <form id="form_validation" method="POST" class="pt-3" action="ajoutservice">
                                      {{ csrf_field() }}
                  ...
                  <div class="input-group" style="background: white;">
                    ...
                    <input type="text" class="form-control" placeholder="Nom Service" name="nom" required>
                  </div>
                </div>
                 <div class="form-group">
                  <label>Sigle</label>
