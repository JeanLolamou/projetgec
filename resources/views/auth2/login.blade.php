      ...
      <div class="user_card">
        <div class="d-flex justify-content-center">
          <div class="brand_logo_container brand_logo">
            <img src="{{ asset('images/armorie.png') }}" class="" alt="Logo" style="width: 80%;height: 100%">
          </div>
        </div>
        <div class="d-flex justify-content-center form_container">
          <form method="POST"  action="{{ route('login') }}">
              @csrf
              <h1 style="text-align: center;color: black;font-weight: bolder; font-size: 350% ">GEC</h1>
              <p style="text-align: center;color: black;font-size: 120%">Gestion Electronique des Courriers</p>
        ...
        <div class="mt-4">
          ...
          <div class="d-flex justify-content-center links">
            <a href="{{ route('motdepassoublier') }}" style="color: black">Mot de passe oublié?</a>
          </div>
        </div>
      </div>
    </div>
