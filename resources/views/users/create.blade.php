            ...
            <div class="form-layout">
              ...
              <div class="row mg-b-25">
                ...
                <div class="col-lg-4">
                    ...
                    <input class="form-control" type="text" name="name"  placeholder="Entrer le nom" required="required">
                  </div>
             <!-- col-4 -->
                ...
                <div class="col-lg-4">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="email" name="email"  placeholder="Enter l'address email" required="required">
                  </div>
                </div><!-- col-4 -->
                <div class="col-lg-4">
                  <div class="form-group">
                    <label class="form-control-label">Numéro de Téléphone<span class="tx-danger">*</span></label>
                    <input class="form-control" type="text" name="telephone"  placeholder="Entrer numéro de Téléphone">
                  </div>
                </div><!-- col-4 -->
                <div class="col-lg-4">
                  <div class="form-group mg-b-10-force">
                    <label class="form-control-label">Mot de Passe <span class="tx-danger">*</span></label>
                    <input class="form-control" type="password" name="password"  placeholder="Entrer Mot de Passe" required="required">
                  </div>
                </div><!-- col-8 -->
                <div class="col-lg-4">
                  <div class="form-group mg-b-10-force">
                    <label class="form-control-label">Poste: <span class="tx-danger">*</span></label>
                    <select class="form-control select2" name="poste" data-placeholder="Choisir un Poste" required="required">
