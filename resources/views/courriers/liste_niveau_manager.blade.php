...
@section('content')
 ...
 <div class="sh-pagetitle-title">
            ...
            <h2>Liste des Courriers Envoyés aux Collaborateurs</h2>
          </div><!-- sh-pagetitle-left-title -->
        </div><!-- sh-pagetitle-left -->
      </div><!-- sh-pagetitle -->
                   
          <div class="sh-pagebody">
               <!-- <div class="card-header bg-primary tx-white">Liste des Courriers Envoyés aux Collaborateurs</div> -->
                  ...
                  <div class="table-responsive mg-t-25">
                                ...
                                <table id="datatable1" class="table display responsive nowrap">
                                    <thead class="bg-info">
                                        ...
                                        <th style="color: white;font-weight: bolder">Collaborateur en Charge</th>
                                                                                       

                                          <!--   <th style="color: black;font-weight: bolder">Reférence</th> -->
                                           
                                           <!--  <th style="color: black;font-weight: bolder">Email</th>
                                            <th style="color: black;font-weight: bolder">Télephone</th> -->
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                           <td><a href="{{route('detailAnnotationCourrier',$courrier->id)}}" class="btn btn-success waves-effect">{{ $courrier->numero }}</a></td>
