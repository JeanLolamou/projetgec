...
@endif<h6 style="text-transform: uppercase;font-weight: bolder;text-align:center">Modifier une Direction: </h6>
        ...
        <div class="row flex-grow">
          <div class="col-lg-12 d-flex align-items-center justify-content-center" >
            <div class="auth-form-transparent text-left p-3">
              ...
              <form id="form_validation" method="POST" class="pt-3" action="{{ route('departementupdate') }}">
                                      {{ csrf_field() }}
                                {{ method_field('PUT') }}
                ...
                <div class="form-group">
                    ...
                    <div class="input-group-prepend bg-transparent">
                      <span class="input-group-text bg-transparent border-right-0">
                        ...
                        <input id="nom" class="form-control" value="{{$editdepartements->nom}}" name="nom" type="text" placeholder="Nom Direction" required="required" >
                      </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="input-group" style="background: white;">
                    ...
                    <input type="text" class="form-control " placeholder="Sigle" name="sigle" value="{{$editdepartements->sigle}}" required>
                  </div>
                </div>
