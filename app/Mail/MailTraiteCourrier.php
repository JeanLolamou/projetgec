...
class MailTraiteCourrier extends Mailable

{
...

    {
       ...
       return $this->subject('Traitement d\' un Courrier GEC')->cc('kadiatou.sall@apip.gov.gn')->view('Emailcourriers/traitementCourrier')->with([
        'nom'=>$this->nomC,
