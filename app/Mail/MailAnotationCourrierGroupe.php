...
class MailAnotationCourrierGroupe extends Mailable

{
    ...
    public function __construct($nom,$commentaire,$objet, $reference, $destinataire,$typeCourrier,$file_path,$lien,$groupe)
...

    {
       ...
       return $this->subject('Annotation d\' un Nouveau Courrier GEC')->cc('kadiatou.sall@apip.gov.gn')->view('Emailcourriers/annotationCourrierGroupe')->with([
        'nom'=>$this->nomC,
