...
class MailEnregistrementCourrier extends Mailable

{
...

    {
       ...
       return $this->subject('Réception d\' un Nouveau Courrier GEC')->cc('kadiatou.sall@apip.gov.gn')->view('Emailcourriers/ajoutCourrier')->with(['objet'=>$this->objetC,'reference'=> $this->referenceC,
